                ...
                <div class="container-fluid">
                    ...
                    <?php if ($laptopCounts > 0) : ?>
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <td>圖片</td>
                                <td><img src="image/<?= $row['images'] ?>" alt="<?= $row['model'] ?>" width="100"></td>
                            </tr>
                            <tr>
                                <td>型號</td>
                                <td><?= $row["model"] ?></td>
                        ...
                        <div class="py-2 d-flex justify-content-between">
                            ...
                            <?php if ($row["state"] == "No") : ?>
                                <a class="btn btn-outline-success" href="laptop_restart.php?id=<?= $row["id"] ?>" title="下架">
                                    <i class="fa-solid fa-play"></i>
                                </a>
                            <?php else: ?>
                                <a class="btn btn-outline-danger" href="laptop_soft_delete.php?id=<?= $row["id"] ?>" title="上架">
