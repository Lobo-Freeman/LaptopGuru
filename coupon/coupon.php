                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php if (strpos($row['coupon_discount'], '-') !== false): ?>
                                <?php
                                    $discount = str_replace('-', '', $row['coupon_discount']);
                                    echo "折扣 {$discount}元";
                                ?>
                            <?php elseif (strpos($row['coupon_discount'], '*') !== false): ?>
                                <?php
                                    $discount = str_replace(['*', '0', '.'], '', $row['coupon_discount']);
                                    echo "打 {$discount}折";
                                ?>
                            <?php endif; ?>
                        </td>
